...
export class NavService {
  private serviceUrl = 'https://servitek.gastrotek.com.mx/proy-servicios/index.php/Controlador/';
  public url='https://servitek.gastrotek.com.mx/proy-servicios/index.php/Controlador/'; // disponer url de su servidor que tiene las páginas PHP

  public urlactualizar='https://servitek.gastrotek.com.mx/proy-servicios/index.php/Controlador2/';
